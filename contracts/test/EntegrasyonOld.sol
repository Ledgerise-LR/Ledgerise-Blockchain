...
contract EntegrasyonOld is ChainlinkClient, Ownable {
    ...
    // Withdraw functions for reusability //

    function withdrawLink() public onlyOwner {

      LinkTokenInterface link = LinkTokenInterface(_chainlinkOracleAddress());
      require(
        link.transfer(msg.sender, link.balanceOf(address(this))),
        "Transfer hatasi, lutfen baska bir zaman tekrar deneyiniz."
      );
    }
}
